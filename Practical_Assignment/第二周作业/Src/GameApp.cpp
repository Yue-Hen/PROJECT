...
void GameApp::UpdateScene(float dt)
{
   ...
   // m_CBuffer.proj = XMMatrixTranspose(XMMatrixOrthographicLH(fov, AspectRatio(), 1.0f, 1000.0f));
    // 更新常量缓冲区
...
bool GameApp::InitEffect()
{
    ...
    // 创建顶点着色器
    HR(CreateShaderFromFile(L"Shaders\\Cube_VS.cso", L"Shaders\\Cube_VS.hlsl", "VS", "vs_5_0", blob.ReleaseAndGetAddressOf()));
    ...
    // 创建像素着色器
    HR(CreateShaderFromFile(L"Shaders\\Cube_PS.cso", L"Shaders\\Cube_PS.hlsl", "PS", "ps_5_0", blob.ReleaseAndGetAddressOf()));
...
bool GameApp::InitResource()
{
    ...
    VertexPosColor vertices[] =
    {
        ...
        { XMFLOAT3(-1.5f, -1.5f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
        { XMFLOAT3(-1.5f, 1.5f, 1.0f), XMFLOAT4(1.0f, 0.0f, 1.0f, 1.0f) },
        { XMFLOAT3(1.5f, 1.5f, 1.0f), XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f) },
        { XMFLOAT3(1.5f, -1.5f, 1.0f), XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f) }
    };
    // 设置顶点缓冲区描述
